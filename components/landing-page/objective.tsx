    ...
    <div className="lg:px-20 py-20 px-6 ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {OBJECTIVE_SCHEMA.map((item, index) => (
          <div
            key={index}
            className="bg-[#1a3321b3] shadow-2xl rounded-lg p-6 max-h-[28rem] flex flex-col justify-between"
          >
            ...
            <a
              href={item.btnLink}
              className="bg-[#c9a84c] grid  justify-center w-60 hover:bg-[#a58a3a] mx-auto text-white font-bold py-2 px-4 rounded-lg mt-4"
            >
              {item.btntext}
            </a>
          </div>
