  ...
  return (
    <section className="py-20 pt-40 px-6 lg:px-20">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white  rounded-3xl shadow-3xl p-8 md:p-12">
          <div className="space-y-8 text-slate-900">
            <div>
              <div className="grid grid-flow-col w-max items-center mb-3">
                <p className="text-2xl  font-playfair-display font-bold uppercase text-[#c9a84c] mb-3">
                  Project Overview
                </p>
                <span>
                  {" "}
              ...
              <p className="text-lg font-montserrat leading-8">
            ...
            <div>
              <p className="text-xl font-playfair-display font-bold uppercase text-[#c9a84c] mb-3">
                The Goal
              </p>
              <p className="text-lg  font-montserrat leading-8">
            ...
            <div>
              ...
              <p className="text-lg  font-montserrat leading-8 mb-5">
              ...
              <ul className="list-disc list-inside space-y-2 text-lg font-montserrat leading-8">
