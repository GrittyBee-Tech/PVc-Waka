          ...
          <div className="space-y-8 text-slate-900">
            <div>
              <div className="grid grid-flow-col w-max items-center mb-3">
                <p className="text-2xl  font-space-grotesk font-bold uppercase text-black mb-3">
                  Project Overview
                </p>
                <span>
                  {" "}
            ...
            <div>
              <p className="text-xl font-space-grotesk font-bold uppercase text-black mb-3">
                The Goal
              </p>
              <p className="text-lg  font-dm-sans leading-8">
            ...
            <div>
              ...
              <p className="text-lg  font-dm-sans leading-8 mb-5">
              ...
              <ul className="list-disc list-inside space-y-2 text-lg font-dm-sans leading-8">
